...
public class HangXeIdAdapter extends RecyclerView.Adapter<HangXeIdAdapter.HangXeIdViewHolder> {
    private Context mContext;
    private List<Xe> mListXe;

    public HangXeIdAdapter(Context context, List<Xe> listXe) {
    ...
    @NonNull
    @Override
    public HangXeIdViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_xe, parent, false);
        return new HangXeIdViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull HangXeIdViewHolder holder, int position) {
    ...
    public class HangXeIdViewHolder extends RecyclerView.ViewHolder {
        private ImageView imgXe;
        private TextView tvTenXe;

        public HangXeIdViewHolder(@NonNull View itemView) {
            super(itemView);
